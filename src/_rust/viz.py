...
class RustVizCore:
    ...
    def _load_library(self):
        ...
        # Development: src/_rust/viz.py -> project_root/src_rust/
        # Installed: usr/share/hiresti/_rust/viz.py -> usr/share/hiresti/src_rust/
        candidates.extend(
            [
                here.parent / "src_rust" / "rust_viz_core" / "target" / "release" / "libviz_core.so",
                here.parent / "src_rust" / "rust_viz_core" / "target" / "release" / "libviz_core.dylib",
                here.parent / "src_rust" / "rust_viz_core" / "target" / "release" / "viz_core.dll",
                here.parent.parent / "src_rust" / "rust_viz_core" / "target" / "release" / "libviz_core.so",
                here.parent.parent / "src_rust" / "rust_viz_core" / "target" / "release" / "libviz_core.dylib",
